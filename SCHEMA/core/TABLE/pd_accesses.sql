...
ALTER TABLE core.pd_accesses OWNER TO vaccine;

REVOKE ALL ON TABLE core.pd_accesses FROM vaccine;
GRANT SELECT ON TABLE core.pd_accesses TO vaccine WITH GRANT OPTION;
